...
# TESTING ke liye (webcam):
SOURCE = 0

# CCTV camera mile jaane ke baad, upar wali line hata kar ye use karo:
# SOURCE = "rtsp://admin:PASSWORD@CAMERA_IP:554/Streaming/Channels/101"
